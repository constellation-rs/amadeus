use itertools::izip;
use ndarray::{
	linalg::{general_mat_mul, general_mat_vec_mul}, ArrayBase, ArrayViewMut, Axis, Data, DataMut, Ix1, Ix2
};

use super::Arr;
use crate::fast_approx::{fastexp, fastlog, tanhf_fast};
...
pub fn mat_mul<S1, S2, S3>(
	alpha: f32, lhs: &ArrayBase<S1, Ix2>, rhs: &ArrayBase<S2, Ix2>, beta: f32,
