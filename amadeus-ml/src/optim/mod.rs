...
use crate::{ParameterNode, Variable};
use barrier::SynchronizationBarrier;
...
pub trait Synchronizable {
	...
	fn synchronized_with_step(
		&self, num_threads: usize, step_size: usize,
...
impl<'a, T: 'a> SynchronizedOptimizer<'a, T> {
	fn new(
		optimizer: &'a T, barrier_guard: barrier::SynchronizationBarrierGuard, step_size: usize,
	) -> Self {
