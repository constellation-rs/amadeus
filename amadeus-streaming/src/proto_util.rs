...
pub const PRECISION_OR_NUM_BUCKETS_TAG: u32 = PRECISION_OR_NUM_BUCKETS_FIELD_NUMBER << 3 | WIRE_TYPE_VAR_INT;
...
pub const NUM_VALUES_TAG: u32 = AGGREGATOR_STATE_PROTO_NUM_VALUES_FIELD_NUMBER << 3 | WIRE_TYPE_VAR_INT;

const AGGREGATOR_STATE_PROTO_ENCODING_VERSION_FIELD_NUMBER: u32 = 3;
pub const ENCODING_VERSION_TAG: u32 = AGGREGATOR_STATE_PROTO_ENCODING_VERSION_FIELD_NUMBER << 3 | WIRE_TYPE_VAR_INT;
...
pub const VALUE_TYPE_TAG: u32 = AGGREGATOR_STATE_PROTO_VALUE_TYPE_FIELD_NUMBER << 3 | WIRE_TYPE_VAR_INT;
...
pub const HYPERLOGLOGPLUS_UNIQUE_STATE_TAG: u32 = AGGREGATOR_STATE_PROTO_HYPERLOGLOG_PLUS_UNIQUE_STATE_FIELD_NUMBER << 3 | WIRE_TYPE_LENGTH_DELIMITED;

const SPARSE_PRECISION_OR_NUM_BUCKETS_FIELD_NUMBER: u32 = 4;
pub const SPARSE_PRECISION_OR_NUM_BUCKETS_TAG: u32 = SPARSE_PRECISION_OR_NUM_BUCKETS_FIELD_NUMBER << 3 | WIRE_TYPE_VAR_INT;
...
#[cfg(test)]
mod test {
    use crate::proto_util::{compute_uint32_size_no_tag, compute_int32_size_no_tag, compute_enum_size_no_tag, compute_int64_size_no_tag};
