...
use super::Schema;
use crate::internal::basic::{LogicalType, Repetition};
...
impl<'a, 'b: 'a> DisplaySchemaGroup<'a, 'b> {
	pub fn new(
		r: Option<Repetition>, name: Option<&str>, logical: Option<LogicalType>,
		fmt: &'a mut fmt::Formatter<'b>,
	) -> Self {
	...
	pub fn field(
		&mut self, name: Option<&str>, value: Option<&impl Schema>,
