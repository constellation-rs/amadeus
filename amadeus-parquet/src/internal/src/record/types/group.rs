...
use std::{
	collections::HashMap, fmt::{self, Debug}, ops::{Index, IndexMut}, str, sync::Arc
};

use crate::{
	basic::Repetition, column::reader::ColumnReader, errors::{ParquetError, Result}, record::{
		reader::GroupReader, schemas::{GroupSchema, ValueSchema}, types::Value, Record
...
impl Group {
	#[doc(hidden)]
	pub fn new(
		fields: Vec<Value>, field_names: Arc<LinkedHashMap<String, usize, FxBuildHasher>>,
	) -> Self {
