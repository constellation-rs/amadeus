...
use crate::internal::{
	basic::{LogicalType, Type as PhysicalType}, file::metadata::{ColumnChunkMetaData, FileMetaData, ParquetMetaData, RowGroupMetaData}, schema::types::Type
};

/// Prints Parquet metadata [`ParquetMetaData`](crate::internal::file::metadata::ParquetMetaData)
/// information.
...
/// Prints file metadata [`FileMetaData`](crate::internal::file::metadata::FileMetaData)
/// information.
#[allow(unused_must_use)]
...
/// Prints Parquet [`Type`](crate::internal::schema::types::Type) information.
#[allow(unused_must_use)]
...
mod tests {
	...
	use crate::internal::{
		basic::{Repetition, Type as PhysicalType}, schema::{parser::parse_message_type, types::Type}
	};
