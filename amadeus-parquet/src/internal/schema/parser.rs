...
//! [`Type`](crate::internal::schema::types::Type).
//!
//! # Example
//!
//! ```rust
...
use crate::internal::{
	basic::{LogicalType, Repetition, Type as PhysicalType}, errors::{ParquetError, Result}, schema::types::{Type, TypePtr}
};

/// Parses message type as string into a Parquet [`Type`](crate::internal::schema::types::Type)
...
impl<'a> Parser<'a> {
	...
	fn add_primitive_type(
		&mut self, repetition: Repetition, physical_type: PhysicalType,
	) -> Result<Type> {
					...
					.with_fields(&mut vec![
						Rc::new(
							Type::group_type_builder("a1")
								...
								.with_fields(&mut vec![Rc::new(
									Type::primitive_type_builder("a2", PhysicalType::ByteArray)
