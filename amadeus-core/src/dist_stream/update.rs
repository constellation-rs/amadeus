...
impl<I: DistributedStreamMulti<Source>, F, Source> DistributedStreamMulti<Source> for Update<I, F>
where
	F: FnMut(&mut <I as DistributedStreamMulti<Source>>::Item) + Clone + ProcessSend,
{
	type Item = I::Item;
	type Task = UpdateConsumer<I::Task, F>;
