...
impl<I: DistributedStreamMulti<Source>, F, Source> DistributedStreamMulti<Source> for Inspect<I, F>
where
	F: FnMut(&<I as DistributedStreamMulti<Source>>::Item) + Clone + ProcessSend,
{
	type Item = I::Item;
	type Task = InspectConsumer<I::Task, F>;
