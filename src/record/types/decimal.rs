...
use crate::{
	basic::Repetition, column::reader::ColumnReader, data_type::{ByteArray, Decimal}, errors::Result, record::{
		schemas::{DecimalSchema, I32Schema, I64Schema}, types::{downcast, Value}, Reader, Record
	...
	fn read(&mut self, def_level: i16, rep_level: i16) -> Result<Self::Item> {
		match self {
			...
			DecimalReader::Array {
				...
				Decimal::from_bytes(ByteArray::from(bytes), *precision as i32, *scale as i32)
			}),
		}
	}
